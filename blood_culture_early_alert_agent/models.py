"""
Clinical Data Models & Enums for BloodCulture Sentinel: Time-to-Positivity & True Pathogen vs Contaminant Arbiter.
Domain: Microbiology
...
class AgentAlert:
    ...
    guideline_citation: str = "CLSI M100 / EUCAST 2024 Breakpoints"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
