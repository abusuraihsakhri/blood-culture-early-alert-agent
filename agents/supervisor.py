"""
Supervisor Orchestrator & Operations Intelligence for Blood Culture Early Alert Agent.
...
class SystemSupervisor:
    """Master Distributed Component Coordinator for Blood Culture Early Alert Agent."""
    ...
    def __init__(self, model_provider: str = "mock"):
        ...
        self.llm = LLMFactory.create(model_provider, system_name="Blood Culture Early Alert Agent")
    ...
    def query_supervisory_chat(self, query: str) -> str:
        ...
        prompt = f"Supervisor inquiry for Blood Culture Early Alert Agent under CLSI M100 / EUCAST / CDC NHSN Guidelines: {query}"
