"""
Autonomous Bayesian Calibration & Active Learning Feedback Engine for blood-culture-early-alert-agent.
"""
import math
...
class ActiveLearningEngine:
    ...
    def __init__(self, system_name: str = "Blood Culture Early Alert Agent"):
