"""
FastAPI REST API Server for Blood Culture Early Alert Agent.
"""
...
app = FastAPI(
    title="Blood Culture Early Alert Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "blood-culture-early-alert-agent", "domain": "Antimicrobial Stewardship & Microbiology", "standard": "CLSI M100 / EUCAST / CDC NHSN Guidelines", "version": "3.0.0-ENTERPRISE"}
